...
<script>
import Popper from 'arche-ui/src/utils/vue-popper';
import Clickoutside from 'arche-ui/src/utils/clickoutside';
import Emitter from 'arche-ui/src/mixins/emitter';
import Locale from 'arche-ui/src/mixins/locale';
import Migrating from 'arche-ui/src/mixins/migrating';
import ElInput from 'arche-ui/packages/input';
import ElTag from 'arche-ui/packages/tag';
import ElScrollbar from 'arche-ui/packages/scrollbar';
import ElCascaderPanel from 'arche-ui/packages/cascader-panel';
import AriaUtils from 'arche-ui/src/utils/aria-utils';
import { t } from 'arche-ui/src/locale';
import { isEqual, isEmpty, kebabCase } from 'arche-ui/src/utils/util';
import { isUndefined, isFunction } from 'arche-ui/src/utils/types';
import { isDef } from 'arche-ui/src/utils/shared';
import { addResizeListener, removeResizeListener } from 'arche-ui/src/utils/resize-event';
